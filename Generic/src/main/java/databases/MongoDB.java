...
public class MongoDB {
    ...
    public String insertIntoMongoDB(List<Students> student, String profileName){
        MongoDatabase mongoDatabase = connectToMongoDB();
    ...
    public List<Students> readStudentListFromMongoDB(String profileName){
        ...
        for(Document doc:iterable){
            ...
            student.setId(id);
            student = new Students(student.getFirstName(),student.getLastName(),student.getScore(),student.getId());
            list.add(student);
        }
        return list;
    }
    public static void main(String[] args){
        insertIntoToMongoDB(new User("Fahim", "4493","01-07-1996"));
